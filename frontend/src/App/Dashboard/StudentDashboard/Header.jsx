        ...
        <header className="relative z-[9998] min-h-16 border-b px-6 flex items-center justify-between gap-4">
            ...
            <div className="ml-auto flex items-center gap-2">
                <Button
                    type="button"
                    variant="outline"
                    onClick={() => activeFormula ? setActiveFormula(null) : openFormula(groups[0] || {})}
                >
            ...
            {activeFormula && (
                <Draggable handle=".formula-sheet-drag-handle" cancel=".formula-sheet-controls" nodeRef={formulaRef}>
                    <section
                        ref={formulaRef}
                        className="absolute left-4 top-16 z-[10001] w-[min(900px,calc(100vw-2rem))] rounded-lg border bg-background p-3 shadow-2xl"
