...
// GET /api/teacher/group-exams
router.get("/group-exams", async (req, res) => {
...
// GET /api/teacher/group-exams/:id
router.get("/group-exams/:id", async (req, res) => {
...
router.get("/group-exams/:id/blocks", async (req, res) => {
...
router.post("/group-exams", async (req, res) => {
